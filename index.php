...
<head>
    ...
    <title>Amplitudo domaci 3</title>
...
<body>
                ...
                <tbody>
                    <?php 
                       ...
                       for($i = 0; $i < count($users); $i++){
                           ...
                           echo "   <td> <a class=\"btn btn-info\" href=\"#\" onclick=\"addCountries(".$users[$i]['id'].")\" >+</a> </td>";
                           echo "</tr> \n ";
                       } 
    ...
    <script>
        ...
        async function showEditModal(id){
            ...
            let response = await fetch("http://localhost/amplitudoDomaci3/api/user.php?id="+id);
        ...
        async function addCountries(id){
            let response = await fetch("http://localhost/amplitudoDomaci3/api/countries.php");
            let responseJSON = await response.json(); 
            ...
            let countriesTxt = "<option selected>Izaberite Drzavu</option>"
            responseJSON.data.forEach((country) => {
                countriesTxt += `<option id="country_${country.id}" value="${country.name}">${country.name}</option>`
                
            })
            countrySelector.innerHTML = countriesTxt;
